...
def create_representations_db(db_path):
    ...
    if representations:
        ...
        representations_file = os.path.join(db_path, f"representations_{timestamp}.pkl")
...
if __name__ == "__main__":
    img_path = "D:/Merrell/Visitor-Monitoring-System/SavedFaces/2025-05-04/osh3.jpg"
    # img_path = "/content/drive/MyDrive/Colab Notebooks/test/sherwin.png"
    exclude_path = img_path
    #saved_path = "D:/Merrell/Visitor-Monitoring-System/SavedFaces"
